...
public class Task10 {
    ...
    public static void main(String[] args) {
        ...
        String email = "elo@gmail.com";
        try{
            System.out.println(EmailAddress.of(email));
        ...
        try {
            System.out.println(EmailAddress.of(username, host));
        } catch (IllegalUsernameException e) {
            System.out.println(username + " is not valid username");
        } catch (IllegalHostException e) {
            System.out.println(host + " int not valid host");
        }
    }
}